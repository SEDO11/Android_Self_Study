...
import org.techtown.sw1.R;
import org.w3c.dom.Text;

public class MainActivity extends AppCompatActivity {

    TextView cityView, weatherView, tempView, dateView, humiView;
    Button wBtn;
    EditText editCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        humiView = (TextView) findViewById(R.id.humiView);
    ...
    public String latLon (String city) {
        ...
        if(city.equals("서울") || city.equals("서울시")) {
            lon = "37.52902713182659" + " " +"126.98584370564363";
        } else if (city.equals("부산") || city.equals("부산시")) {
            lon = "35.17971206113396" + " " + "129.07502533651083";
        } else if (city.equals("대구") || city.equals("대구시")) {
            lon = "35.868178380060996" + " " + "128.5806281121894";
        } else if (city.equals("인천") || city.equals("인천시")) {
            lon = "37.45603972071989" + " " + "126.70587037086081";
        } else if (city.equals("광주") || city.equals("광주시")) {
            lon = "35.15994501030649" + " " + "126.8513577806873";
        } else if (city.equals("울산") || city.equals("울산시")) {
            lon = "35.539034699322144" + " " + "129.31128293861397";
        } else if (city.equals("세종") || city.equals("세종시")) {
            lon = "36.480140506578" + " " + "127.28882917092174";
        } else if (city.equals("경기") || city.equals("경기도")) {
            lon = "37.27491443264456" + " " + "127.0091917091811";
        } else if (city.equals("강원") || city.equals("강원도")) {
            lon = "37.86292436315532" + " " + "127.73312217355867";
        } else if (city.equals("충북") || city.equals("충청북도")) {
            lon = "36.635629413623" + " " + "127.49138308910058";
        } else if (city.equals("충남") || city.equals("충청남도")) {
            lon = "36.65984296872477" + " " + "126.67258032525156";
        } else if (city.equals("전북") || city.equals("전라북도")) {
            lon = "35.82027298461823" + " " + "127.10880209974063";
        } else if (city.equals("전남") || city.equals("전라남도")) {
            lon = "34.81612168959558" + " " + "126.46292419786823";
        } else if (city.equals("경북") || city.equals("경상북도")) {
            lon = "36.57649124965447" + " " + "128.5059126687219";
        } else if (city.equals("경남") || city.equals("경상남도")) {
            lon = "35.23817656270288" + " " + "128.69243018438465";
        } else if (city.equals("제주") || city.equals("제주도")) {
            lon = "33.49955543024103" + " " + "126.53124172452273";
        } else if (city.equals("울릉도")) {
            lon = "37.50796085833531" + " " + "130.85702733102426";
        } else if (city.equals("독도")) {
            lon = "37.23928353528971" + " " + "131.8682408214758";
        } else { //지역이 없을경우
            lon = "";
        }
        return lon;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    dateView.setText("날짜, 시간\n" + getDate);

                    JSONObject jsonObject = new JSONObject(response);

                    //입력받은 지역 출력
                    cityView.setText("지역: " + editCity.getText().toString());
                    ...
                    //weather view에 날씨 출력
                    weatherView.setText("날씨: " + weather);
                    ...
                    //temp view에 날씨 출력
                    tempView.setText("기온: " + tempDo + "°C");
                    humiView.setText("습도: " + humidity +"%");
